...
- [x] Пользователь должен иметь возможность просматривать все проекты;
- [x] Авторизованный пользователь должен иметь возможность создавать и редактировать только свои проекты;
- [x] Пользователи из списка `owners` конкретного проекта могут редактировать любые поля;
- [ ] Пользователи из списка `executors` для конкретного проекта могут редактировать только поля `isStarted` и `isDone`;
- [x] Авторизация;
- [x] Регистрация;
- [ ] Забыли пароль;
- [ ] Авторизованный пользователь может искать других по `username` и добавлять с качестве исполнителей (в список `executors`) для конкретной работы;
- [ ] ДОП: Прогноз исполнителя может быть спрогнозирован на основании его прогнозов и реальных окончаний работ за последние пол-года;
