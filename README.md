...
- [ ] Авторизованный пользователь должен иметь возможность:
  - [ ] Просматривать любые Ремонты и затраты по выполненным работам;
- [ ] Авторизованный пользователь из списка `owners` (далее _Собственник_) **в рамках конкретного проекта** должен иметь возможность:
  - [ ] Добавлять других пользователей с список `executors` (далее _Исполнители_):
  - [x] Редактировать любые поля;
  - [ ] Искать других по `username` и добавлять в список Исполнителей по конкретному ремонту (или по конкретной работе?);
- [ ] Пользователь из списка `executors` для конкретного проекта может редактировать только поля:
  - [ ] `isStarted` _(Начать работу)_;
  - [x] ~~`isDone` _(Завершить работу)_;~~
